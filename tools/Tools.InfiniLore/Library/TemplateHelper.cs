...
public class TemplateHelper {
    public async Task<string> LoadTemplateModuleSetupFileAsync(string moduleName, string mode, string rootPath, CancellationToken ct = default) {
        string templatePath = Path.Combine(rootPath, "Commands", "ModuleSetup", "Templates", "TemplateModuleSetup.txt");
