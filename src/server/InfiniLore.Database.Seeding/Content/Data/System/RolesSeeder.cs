...
public class RolesSeeder(RoleManager<IdentityRole> roleManager, ILogger logger) : ISeeder {
    ...
    public async Task StartSeedingAsync(CancellationToken ct = default) {
        ...
        IdentityRole[] roles = [
            new("admin") { NormalizedName = "ADMIN", Id = "0b3715f5-d1d2-4ffb-b869-0ab2462ad504" },
            new("user") { NormalizedName = "USER", Id = "b693ab6e-5a2c-4093-947d-e1e1f3797294" }
        ];
