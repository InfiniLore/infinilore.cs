...
public interface IInteractiveApiLoreScopes  {
    ...
    ValueTask<Outcome> UpdateLoreScopeMetaDataAsync(string userId, string loreScopeId, string? newLoreScopeName = null, string? newDescription = null, CancellationToken ct = default);
}
