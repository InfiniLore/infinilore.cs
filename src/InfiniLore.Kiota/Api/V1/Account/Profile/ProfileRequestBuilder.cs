...
using System;
namespace InfiniLore.Kiota.Api.V1.Account.Profile
{
    /// <summary>
    /// Builds and executes requests for operations under \api\v1\account\profile
    /// </summary>
    ...
    public partial class ProfileRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::InfiniLore.Kiota.Api.V1.Account.Profile.Item.WithUserItemRequestBuilder this[string position]
        {
            get
            {
                ...
                return new global::InfiniLore.Kiota.Api.V1.Account.Profile.Item.WithUserItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
...
#nullable enable
        public async Task<global::InfiniLore.Kiota.Models.KiotaUserUserProfilesResponse?> GetAsync(Action<RequestConfiguration<global::InfiniLore.Kiota.Api.V1.Account.Profile.ProfileRequestBuilder.ProfileRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::InfiniLore.Kiota.Models.KiotaUserUserProfilesResponse> GetAsync(Action<RequestConfiguration<global::InfiniLore.Kiota.Api.V1.Account.Profile.ProfileRequestBuilder.ProfileRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::InfiniLore.Kiota.Models.KiotaUserUserProfilesResponse>(requestInfo, global::InfiniLore.Kiota.Models.KiotaUserUserProfilesResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <returns>A <see cref="RequestInformation"/></returns>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::InfiniLore.Kiota.Api.V1.Account.Profile.ProfileRequestBuilder.ProfileRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::InfiniLore.Kiota.Api.V1.Account.Profile.ProfileRequestBuilder.ProfileRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::InfiniLore.Kiota.Api.V1.Account.Profile.ProfileRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::InfiniLore.Kiota.Api.V1.Account.Profile.ProfileRequestBuilder WithUrl(string rawUrl)
        {
            return new global::InfiniLore.Kiota.Api.V1.Account.Profile.ProfileRequestBuilder(rawUrl, RequestAdapter);
        }
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
