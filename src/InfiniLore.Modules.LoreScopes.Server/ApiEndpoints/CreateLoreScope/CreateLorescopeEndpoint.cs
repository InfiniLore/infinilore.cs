...
public class CreateLorescopeEndpoint(
...
) : Endpoint<CreateLorescopeRequest, Response, LoreScopeMapper> {
    ...
    // Execute Methods
    // -----------------------------------------------------------------------------------------------------------------
    public override async Task<Response> ExecuteAsync(CreateLorescopeRequest req, CancellationToken ct) {
